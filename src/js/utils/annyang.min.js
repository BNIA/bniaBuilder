...
document.getElementById('speech').innerHTML = "<button> Speech Recognition </button>";
...
if (annyang) {
  var commands = {
    'show on map' : function() {
      ...
      document.getElementById("toggle_view").click();
    },
    'show table' : function() {
      document.getElementById("toggle_view").click();
    },
    'show Menu' : function() {
      document.getElementById("toggle_header_menu").click();
    },
    'hide Menu' : function() {
      document.getElementById("toggle_header_menu").click();
    },
    'show about' : function() {
      document.querySelector('[title=modal_About]').click();
    },
    'hide about' : function() {
  	  modal.style.display = "none";
    },
    'show contact' : function() {
      document.querySelector('[title=modal_Contact_Us]').click();
    },
    'hide contact' : function() {
  	  modal.style.display = "none";
    },
    'show help' : function() {
      document.querySelector('[title=modal_Help]').click();
    },
    'hide help' : function() {
  	  modal.style.display = "none";
    },
